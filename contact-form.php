...
<form id="contact-form" method="post" class="p">
    ...
    <div class="contact-field">
        <label class="contact-label"><?php _ex( 'Name', 'contact form', 'risen' ); ?> <i class="icon-comment-alt"></i></label>
        <input type="text" name="name">
    </div>

    <div class="contact-field">
        <label class="contact-label"><?php _ex( 'E-mail', 'contact form', 'risen' ); ?> <i class="icon-envelope"></i></label>
    ...
    <div id="contact-recaptcha" class="contact-field">
        <?php echo recaptcha_get_html( $recaptcha_public_key, null, is_ssl() ); ?>
    </div>
    <?php endif; ?>
